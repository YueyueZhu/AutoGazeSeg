"""Kvasir-SEG image and dual-pseudo-mask datasets."""
...
class KvasirDataset(BaseImageDataset):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.images = [
            self.root / "images" / f"{name}.jpg" for name in self.sample_list
        ]
        self.labels = [self.root / "masks" / f"{name}.jpg" for name in self.sample_list]
        self.embeddings = [
...
class KvasirGazeDataset(KvasirDataset):
