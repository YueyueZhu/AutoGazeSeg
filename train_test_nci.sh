...
DATA_ROOT="$(project_path "${DATA_ROOT:-data/NCI-ISBI}")"
...
CKPT_PATH="$(project_path "${CKPT_PATH:-${CHECKPOINT_DIR}/AutoGazeSeg_nci_seed${SEED}.pth}")"
SAVE_NAME="${SAVE_NAME:-AutoGazeSeg_nci_seed${SEED}}"
