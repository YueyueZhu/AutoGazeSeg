...
DATA_ROOT="$(project_path "${DATA_ROOT:-data/BraTS2019}")"
...
CKPT_PATH="$(project_path "${CKPT_PATH:-${CHECKPOINT_DIR}/AutoGazeSeg_brats2019_seed${SEED}.pth}")"
SAVE_NAME="${SAVE_NAME:-AutoGazeSeg_brats2019_seed${SEED}}"
