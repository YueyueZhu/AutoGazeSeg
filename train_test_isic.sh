...
DATA_ROOT="$(project_path "${DATA_ROOT:-data/ISIC}")"
...
CKPT_PATH="$(project_path "${CKPT_PATH:-${CHECKPOINT_DIR}/AutoGazeSeg_isic_seed${SEED}.pth}")"
SAVE_NAME="${SAVE_NAME:-AutoGazeSeg_isic_seed${SEED}}"
